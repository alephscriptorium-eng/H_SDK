...
| WP | P | BRIEF | CA | deps | ejes |
| -- | - | ----- | -- | ---- | ---- |
| **RH-04** | P0 | 🔶 DEVUELTO 2026-08-03 · contrarrevisión · BRIEF plan/REPORTES/BRIEF-RH-04-matriz-contratos.md · fix: scripts/rh-04-matriz-contratos.mjs verdictFor no puede VERDE si dts_found vacío aunque hasTypesInExports=true; regenerar matriz/JSON/reporte · Matriz ejecutable desde install limpio H | matriz paquete×gate en plan/REPORTES con verdes/rojos observados; cero paths sibling en resolucion | RH-02 | III, IV |
