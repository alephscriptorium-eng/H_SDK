...
| **RH-09** | P0 | 🔶 GO 2026-08-03 lote-5 · BRIEF plan/REPORTES/BRIEF-RH-09-gate-publish-g.md · Rechazar document-machine sucio; gate 4 tarballs tipados en install aislado | gate G abre solo tras install+typecheck aislado; grep tarball sin h-sdk ni ledger local | RH-07, RH-08 | II, I, ceguera |
